...
num_layers =  8#@param {type:"number"}
...
def texts2r_image(class_name, templates, device, clip_model, clip_img):
    ...
    R_image_temp = R_img_resize(R_image_temp)
    return torch.from_numpy(R_image_temp)